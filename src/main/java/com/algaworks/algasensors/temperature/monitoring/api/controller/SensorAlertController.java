...
public class SensorAlertController {
    ...
    public SensorAlertOutput getSensorAlert(@PathVariable TSID sensorId) {
        ...
        return sensorAlertToOutput(sensorAlert);
    }

    @PutMapping
    public SensorAlertOutput saveSensorAlert(@PathVariable TSID sensorId, @RequestBody SensorAlertInput input) {
        SensorAlert sensorAlert = sensorAlertRepository.findById(new SensorId(sensorId))
    ...
    private static SensorAlertOutput sensorAlertToOutput(SensorAlert sensorAlert) {
